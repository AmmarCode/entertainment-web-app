    ...
    <>
      ...
      >
        <svg
          ...
          className="home nav-icon absolute w-[16px] h-[16px] left-[121px] top-[20px] s:w-[20px] s:h-[20px] s:left-[298px] s:top-[50px] md:left-[70px] md:top-[168px]"
          viewBox="0 0 20 20"
          tabIndex={0}
      ...
      >
        <svg
          ...
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
          className="movies nav-icon absolute w-[16px] h-[16px] left-[161px] top-[20px] s:w-[20px] s:h-[20px] s:left-[350px] s:top-[50px] md:left-[70px] md:top-[228px]"
          tabIndex={0}
      ...
      >
        <svg
          ...
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
          className="tv-series nav-icon absolute w-[16px] h-[16px] left-[201px] top-[20px] s:w-[20px] s:h-[20px] s:left-[402px] s:top-[50px] md:left-[70px] md:top-[288px]"
          tabIndex={0}
          onClick={() => handleNavIconClick("tv series")}
        >
      ...
      >
        <svg
          ...
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
          className="bookmarks nav-icon absolute w-[13.54px] h-[16px] left-[241px] top-[20px] s:w-[16.92px] s:h-[20px] s:left-[454px] s:top-[50px] md:left-[72px] md:top-[348px]"
          tabIndex={0}
